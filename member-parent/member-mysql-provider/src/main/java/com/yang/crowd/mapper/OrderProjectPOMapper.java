...
import com.yang.crowd.entity.po.OrderProjectPO;
import com.yang.crowd.entity.po.OrderProjectPOExample;
...
public interface OrderProjectPOMapper {
    ...
    OrderProjectVO selectOrderProjectVOStaticMoney(@Param("projectId")Integer projectId);
}